                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- forms -->
                            <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/UpdateDataAkunCon'); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <br>
                                    <button onclick="javascript:return confirm('Anda yakin ingin mengubah data ini?')" type="submit" class="btn btn-info col-sm-2 float-right" style="margin-right: 0px;">Ubah</button>
                                </div>
